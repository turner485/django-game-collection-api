        ...
        >
            ...
            <form onSubmit={handleSubmit}>
                <div className='inner-form'> 
                    ...
                    <TextField id="outlined-basic" label="" variant="outlined" type="date" name="release_date" value={formData.release_date} onChange={handleChange} required />
